        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-bold mb-4 border-b pb-2">Upcoming Appointments</h3>
                    <div class="mt-4">
                        <table class="min-w-full divide-y divide-gray-200 datatable">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $apt->appointment_date }} at {{ $apt->appointment_time }}</td>
