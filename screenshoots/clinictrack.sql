...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2026 at 08:59 AM
...
ALTER TABLE `bed_allotments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `bed_allotments_patient_id_foreign` (`patient_id`);
...
--
ALTER TABLE `bed_allotments`
  ADD CONSTRAINT `bed_allotments_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE;
